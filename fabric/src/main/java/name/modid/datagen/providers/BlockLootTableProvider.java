...
public class BlockLootTableProvider extends SimpleFabricLootTableProvider {
  private final float BASE_STONE_CHANCE = 0.025f;
    ...
    exporter.accept(loot("jewelry_table"),
        LootTable.builder()
            .pool(LootPool.builder()
                ...
                .with(ItemEntry.builder(BlocksRegistry.jewelryTable()))
        ...
        LootTable.builder()
            .pool(
                LootPool.builder()
                    ...
                    .with(ItemEntry.builder(ItemsRegistry.stoneGeode())))
            .pool(
                LootPool.builder()
                    .rolls(ConstantLootNumberProvider.create(1))
                    .conditionally(SurvivesExplosionLootCondition.builder())
                    ...
                    .with(ItemEntry.builder(ItemsRegistry.deepslateGeode()))));
  }
