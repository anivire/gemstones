...
public class ScarabParticleFactory implements ParticleFactory<ScarabParticleEffect> {
  ...
  @Override
  public Particle createParticle(ScarabParticleEffect type, ClientWorld world,
