...
public class ModifierOnBeforeBlockBreak implements GemstoneModifier {
  ...
  public ModifierOnBeforeBlockBreak(ArrayList<Double> value, ArrayList<Double> additionalValue,
