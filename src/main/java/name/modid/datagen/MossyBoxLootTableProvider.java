    ...
    exporter.accept(
        ...
        LootTable.builder()
            ...
            .pool(LootPool.builder()
                ...
                .with(ItemEntry.builder(GemstonesRegistrationHelper.getCelestineGemstones().get(0)).weight(1))
                .with(ItemEntry.builder(GemstonesRegistrationHelper.getCelestineGemstones().get(1)).weight(1))
                .with(ItemEntry.builder(GemstonesRegistrationHelper.getAquamarineGemstones().get(0)).weight(1))
                .with(ItemEntry.builder(GemstonesRegistrationHelper.getAquamarineGemstones().get(1)).weight(1))
                .with(ItemEntry.builder(GemstonesRegistrationHelper.getZirconGemstones().get(0)).weight(1))
                .with(ItemEntry.builder(GemstonesRegistrationHelper.getZirconGemstones().get(1)).weight(1))
