...
public class ModifiersRegistry {
  private static final Map<GemstoneType, Map<ModifierItemCategory, Map<GemstoneRarity, GemstoneModifier>>> CACHED_MODIFIERS = new ConcurrentHashMap<>();

  public static Map<ModifierItemCategory, Map<GemstoneRarity, GemstoneModifier>> getModifiersForGemstone(
      GemstoneType type) {
