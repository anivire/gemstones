...
import name.modid.core.api.events.EventAreaEffect;
import name.modid.core.api.events.EventDetonate;
import name.modid.core.api.events.EventHarvestMark;
import name.modid.core.api.events.EventIncreaseSpawnrate;
import name.modid.core.api.events.EventOnBeforeBlockBreak;
import name.modid.core.api.events.EventOnBlockBreak;
import name.modid.core.api.events.EventOnDamage;
import name.modid.core.api.events.EventOnHitEffectModifiers;
import name.modid.core.api.events.EventOnHitMelee;
import name.modid.core.api.events.EventOnHitProjectile;
import name.modid.core.api.events.EventProjectileSpeed;
import name.modid.core.api.events.EventStunned;
