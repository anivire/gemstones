...
public final class CustomEvents {
  ...
  public static final Event<OnFirstHit> ON_FIRST_HIT = EventFactory.createArrayBacked(
      OnFirstHit.class,
  ...
  public static final Event<OnFishing> ON_FISHING = EventFactory.createArrayBacked(
      OnFishing.class,
  ...
  public static final Event<OnHitMelee> ON_HIT_MELEE = EventFactory.createArrayBacked(
      OnHitMelee.class,
  ...
  public static final Event<OnHitProjectile> ON_HIT_PROJECTILE = EventFactory.createArrayBacked(
      OnHitProjectile.class,
  ...
  public static final Event<OnPotionBrew> ON_POTION_BREW = EventFactory.createArrayBacked(
      OnPotionBrew.class,
