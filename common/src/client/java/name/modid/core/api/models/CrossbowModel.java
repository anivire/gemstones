...
public class CrossbowModel {
  public static void register() {
    ItemPropertiesRegistry.register(Items.CROSSBOW, Identifier.of("minecraft", "pull"),
    ...
    ItemPropertiesRegistry.register(Items.CROSSBOW, Identifier.of("minecraft", "pulling"),
